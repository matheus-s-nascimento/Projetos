	...
	<head>
		...
		<script>
			function editar(id, txt_tarefa){
				...
				form.action = 'tarefa_controler.php?acao=atualizarPendentes';
				form.method = 'post'
				form.className = 'row'
				// criar um input para entrade de texto
				...
				let button = document.createElement('button')
					...
					// limpa o texto da tarefa para inclusao no form
			...
			function remover(id){
				location.href ='index.php?acao=removerPendentes&id='+id;
			}
			function marcarRealizado(id){
				location.href ='todas_tarefas.php?acao=marcarRealizadoPendentes&id='+id;
			}
